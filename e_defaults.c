...
int colors[NUM_COLORS] =
{
    ...
    [DEF_COLOR_LINE_TWO_SIDED]    = 0xFFFF00,
    [DEF_COLOR_LINE_SPECIAL]      = 0xFF00FF,
    [SELECTION_BOX]     = 0xFFFFFF,
#else
    [BACKGROUND]        = 0xFFFFFF,
    [GRID_LINES]        = 0xE8E8E8,
    [GRID_TILES]        = 0xD0D0D0,
    ...
    [DEF_COLOR_LINE_TWO_SIDED]    = 0x0000FF,
    [DEF_COLOR_LINE_SPECIAL]      = 0xFF00FF,
    [SELECTION_BOX]     = 0x000000,
#endif
...
Default defaults[] =
{
    ...
    COLOR_DEFAULT(DEF_COLOR_LINE_TWO_SIDED),
    COLOR_DEFAULT(DEF_COLOR_LINE_SPECIAL),
